...
public class ToastService : IToastService
{
    ...
    /// </summary>
    public event Action<ToastLevel, string, string, Action> OnShow;
    ...
    /// </summary>        /// <param name="level">Toast level to display</param>
    /// <param name="message">RenderFragment to display on the toast</param>
    /// <param name="heading">The text to display as the toasts heading</param>
    /// <param name="onClick">Action to be executed on click</param>
    private void ShowToast(ToastLevel level, string message, string heading = "", Action? onClick = null)
    {
